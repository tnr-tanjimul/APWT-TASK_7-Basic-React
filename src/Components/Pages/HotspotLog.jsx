...
function HostspotLog(){
    const [companys, setCompany] = useState([]);

    useEffect(()=>{
        axios.get("http://127.0.0.1:8000/api/hotspot/log/")
        .then(resp=>{
                    ...
                    <div className="table-responsive">
                                            <table className="table table-striped mb-0">
                                                ...
                                                companys.map(company=>(
                                                    ...
                                                    <Company Key={company.serverId} Id={company.serverId} Name={company.time} LicenseNo={company.topics} Address={company.message} Phone={company.serverName} Email={company.serverId}></Company>
                                                ))
                                            }
